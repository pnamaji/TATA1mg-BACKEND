...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # For static files inside a 'static' folder in your project
]
...
#         'HOST': 'localhost',  # Or the remote server IP if PostgreSQL is running on a different machine
...
JAZZMIN_SETTINGS = {
    ...
    "copyright": "Aigetai Private Limited",
